...
z2k_template_suggested_title: "Huberman Lab - {{Interviewee}}"
z2k_card_source_type: ".:Z2K/SourceType/Podcast"
---
{{fieldInfo Interviewer value="Andrew Huberman" directives="no-prompt"}}
{{fieldInfo ShowName value="Huberman Lab" directives="no-prompt"}}
