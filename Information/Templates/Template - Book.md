...
z2k_template_default_title: "{{format-string-file-friendly Title}} - {{format-string-file-friendly Author}}"
Author: "{{Author}}"
Title: "{{Title}}"
FullTitle: "{{FullTitle}}"
---
...
{{~prompt-info Author            "text" "Enter the name of the author (without wikilinks):" "Walt Whitman"}}
{{~prompt-info Title             "text" "Enter a brief version of the book title (to be used in the card title):"}}
{{~prompt-info FullTitle         "text" "Enter the full title of the book:" "{{Title}}" "{{Title}}"}}
{{~prompt-info PersonalLocation  "multiSelect:Audible, Kindle, Physical, Public Library" "Where or how is this book stored?"}}
